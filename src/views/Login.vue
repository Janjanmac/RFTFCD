  ...
  @media (max-width: 768px) {
    ...
    .system-header h2 { font-size: 22px; }
    .system-info > p { font-size: 14px; margin-bottom: 20px; }
  ...
  @media (max-width: 640px) {
    ...
    .system-header h2 { font-size: 18px; }
    .system-info > p { font-size: 12px; margin-bottom: 16px; }
